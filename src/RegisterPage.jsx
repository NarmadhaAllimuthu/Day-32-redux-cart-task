...
function RegisterPage() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const authorData = await axios.post("/register", values);
        ...
        if (error.response.status === 401) {
          alert("User already exists. Change data to RegisterPage.");
        } else {
              ...
              <div className="p-5">
                ...
                <form className="user" onSubmit={formik.handleSubmit}>
                  ...
                  {/* <a href="index.html" className="btn btn-google btn-danger btn-user btn-block">
                    <i className="fab fa-google fa-fw"></i> RegisterPage with Google
                  </a> */}
                  {/* <a href="index.html" className="btn btn-facebook btn-warning btn-user btn-block">
                                <i className="fab fa-facebook-f fa-fw"></i> RegisterPage with Facebook
                            </a> */}
                </form>
                <hr />
